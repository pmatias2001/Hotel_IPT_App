...
namespace Hotel_IPT_App.Data.Migrations
{
    ...
    [Migration("20210707010340_IdentityRole")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Hotel_IPT_App.Models.Fotos", b =>
                {
            ...
            modelBuilder.Entity("Hotel_IPT_App.Models.Quartos", b =>
                {
            ...
            modelBuilder.Entity("Hotel_IPT_App.Models.Reservas", b =>
                {
            ...
            modelBuilder.Entity("Hotel_IPT_App.Models.Utilizadores", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = "c",
                            ConcurrencyStamp = "cc9789e8-7ba0-48a8-8223-0df8ca8d7b40",
                            Name = "Criador",
            ...
            modelBuilder.Entity("Hotel_IPT_App.Models.Fotos", b =>
                {
                    b.HasOne("Hotel_IPT_App.Models.Quartos", "Quarto")
                        .WithMany("ListaFotos")
            ...
            modelBuilder.Entity("Hotel_IPT_App.Models.Reservas", b =>
                {
                    b.HasOne("Hotel_IPT_App.Models.Utilizadores", "Cliente")
            ...
            modelBuilder.Entity("QuartosReservas", b =>
                {
                    b.HasOne("Hotel_IPT_App.Models.Quartos", null)
                        .WithMany()
                        .HasForeignKey("ListaQuartosIdQuarto")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Hotel_IPT_App.Models.Reservas", null)
                        .WithMany()
