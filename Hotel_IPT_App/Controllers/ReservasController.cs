...
namespace Hotel_IPT_App.Controllers
{
    public class ReservasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdReserva,DataInicial,DataFim,NPessoas,Estado,UserFK")] Reservas reservas)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdReserva,DataInicial,DataFim,NPessoas,Estado,UserFK")] Reservas reservas)
        {
